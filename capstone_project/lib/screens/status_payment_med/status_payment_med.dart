...
class StatusPaymentMedScreen extends StatefulWidget {
  ...
  const StatusPaymentMedScreen({super.key, required this.idRiwayatTransaksi});
      ...
      return Consumer<StatusMedPaymentProvider>(
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            leading: IconButton(
              onPressed: () {
                Navigator.of(context).pushReplacementNamed('/medHistory');
              },
              icon: const Icon(
                Icons.arrow_back,
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Image.asset(
                        medTranDet.statusData?.results.paymentStatus ==
                                "pending"
                  ...
                  Text(
                    DateFormat('d MMMM y, HH:mm', 'id_ID')
                        .format(medTranDet.statusData!.results.createdAt),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            medTranDet.statusData?.results.medicineTransaction
                                    .paymentMethod ??
                                ''.toUpperCase(),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${medTranDet.statusData!.results.id} ',
                                  style: ThemeTextStyle().titleSmall),
                              InkWell(
                                onTap: () {
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Builder(builder: (context) {
                            if (medTranDet.statusData?.results.paymentStatus ==
                                "pending") {
                              return Padding(
                                    ...
                                    const Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                            width: 250,
                                            child: Text(
                                                'Paket sedang di kirim ke alamat yang bersangkutan')),
                                      ],
                                    )
                                  ],
                                ),
