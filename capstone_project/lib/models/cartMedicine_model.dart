...
//
//     final cartMedicine = cartMedicineFromJson(jsonString);

import 'dart:convert';

CartMedicine cartMedicineFromJson(String str) => CartMedicine.fromJson(json.decode(str));

String cartMedicineToJson(CartMedicine data) => json.encode(data.toJson());
...
class CartMedicine {
    ...
    factory CartMedicine.fromJson(Map<String, dynamic> json) => CartMedicine(
